...
!!! warning
    ...
    Pull requests are welcome, but modifications to auto-generated code will be rejected. See [CONTRIBUTING](https://github.com/timonrieger/immich-py/blob/main/CONTRIBUTING.md) for more details.
