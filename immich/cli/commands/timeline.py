...
def get_time_bucket(
    ...
    is_favorite: bool | None = typer.Option(None, "--is-favorite", help="""Filter by favorite status (true for favorites only, false for non-favorites only)"""),
    is_trashed: bool | None = typer.Option(None, "--is-trashed", help="""Filter by trash status (true for trashed assets only, false for non-trashed only)"""),
    ...
    with_coordinates: bool | None = typer.Option(None, "--with-coordinates", help="""Include location data in the response"""),
    with_partners: bool | None = typer.Option(None, "--with-partners", help="""Include assets shared by partners"""),
    with_stacked: bool | None = typer.Option(None, "--with-stacked", help="""Include stacked assets in the response. When true, only primary assets from stacks are returned."""),
) -> None:
    """Get time bucket
