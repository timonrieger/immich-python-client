...
def add_users_to_album(
    ctx: typer.Context,
    id: str,
    album_users: list[str] = typer.Option(..., "--albumUsers", help="key=value pairs (repeatable); e.g. key1=value1,key2=value2"),
) -> None:
...
def create_album(
    ...
    album_users: list[str] | None = typer.Option(None, "--albumUsers", help="key=value pairs (repeatable); e.g. key1=value1,key2=value2"),
...
def get_all_albums(
    ctx: typer.Context,
    asset_id: str | None = typer.Option(None, "--asset-id", help="""Only returns albums that contain the asset
