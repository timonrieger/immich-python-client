...
def create_notification(
    ctx: typer.Context,
    data: str | None = typer.Option(None, "--data", help="key=value pairs (repeatable); e.g. key1=value1,key2=value2"),
...
Docs: https://api.immich.app/endpoints/notifications-admin/createNotification
    ...
    result = run_command(client, client.notifications_admin, 'create_notification', **kwargs)
...
Docs: https://api.immich.app/endpoints/notifications-admin/getNotificationTemplateAdmin
    ...
    client = ctx.obj['client']
    result = run_command(client, client.notifications_admin, 'get_notification_template_admin', **kwargs)
    format_mode = ctx.obj.get('format', 'pretty')
    print_response(result, format_mode)
...
Docs: https://api.immich.app/endpoints/notifications-admin/sendTestEmailAdmin
    ...
    client = ctx.obj['client']
    result = run_command(client, client.notifications_admin, 'send_test_email_admin', **kwargs)
    format_mode = ctx.obj.get('format', 'pretty')
    print_response(result, format_mode)
