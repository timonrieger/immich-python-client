...
def get_map_markers(
    ctx: typer.Context,
    file_created_after: str | None = typer.Option(None, "--file-created-after", help="""Filter assets created after this date"""),
    file_created_before: str | None = typer.Option(None, "--file-created-before", help="""Filter assets created before this date"""),
    is_archived: bool | None = typer.Option(None, "--is-archived", help="""Filter by archived status"""),
    is_favorite: bool | None = typer.Option(None, "--is-favorite", help="""Filter by favorite status"""),
    with_partners: bool | None = typer.Option(None, "--with-partners", help="""Include partner assets"""),
    with_shared_albums: bool | None = typer.Option(None, "--with-shared-albums", help="""Include shared album assets"""),
) -> None:
